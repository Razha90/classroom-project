...
export default function Header({ language, setHeaderHeight }) {
  ...
  return (
    <header ref={headerRef} className="px-[7%] py-[1%] bg-primary fixed w-full z-50 flex items-center justify-between" id="get-height">
        ...
        <ul className="list-none p-0 m-0 flex flex-row items-center gap-5">
          {session ? (
            ...
            <li>
              ...
              >
                <Image src="/img/login-icon.png" width="50" height="50" />
                <p>{language.login}</p>
              </Link>
            </li>
          )}
