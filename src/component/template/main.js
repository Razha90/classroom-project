...
export default function Main({ language, headerHeight }) {
  ...
  return (
    <main className="md-415:px-0 transition-all duration-300 ease-in-out w-full">
      <article id="plan1" className="bg-primary px-[12%] lg-540:px-0 transition-all" style={{ paddingTop: `${headerHeight}px` }}>
        <div className="relative w-full flex flex-col bg-cover rounded-2xl aspect-video items-center justify-center lg-540:rounded-none lg-540:h-auto bg-[url('/img/bg-teknik.jpg')] h-[calc(35vw)] transition-all">
          ...
          <div className="relative bg-white/35 backdrop-blur-md rounded-lg p-6 max-w-md z-40 text-secondary font-inter">
            ...
            <p>{language.plan1.description}</p>
          </div>
        </div>
      </article>
